  ...
  return (
    <div className="flex">
      <div ref={sidebarRef} className={`fixed z-10 w-60 h-screen p-4 bg-gray-300 text-white flex flex-col justify-between shadow-lg transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out`}>
        ...
        <Link href="/">
            <div className="bg-white text-purple-800 p-3 rounded-lg flex items-center mb-4 cursor-pointer hover:bg-gray-200 transition-all">
          ...
          <Link href="/">
            <div className="bg-gray-200 text-gray-900 hover:bg-gray-300 cursor-pointer my-4 p-3 pr-20 rounded-lg flex items-center transition-all w-full">
              <RxDashboard size={20} />
              <span className="ml-2 font-medium">Dashboard</span>
            </div>
          </Link>
          <Link href="/customers">
          <div className="bg-gray-200 text-gray-900 hover:bg-gray-300 cursor-pointer my-4 p-3 pr-24 rounded-lg flex items-center transition-all w-full">
              <RxPerson size={20} />
          ...
          <div className="bg-gray-200 text-gray-900 hover:bg-gray-300 cursor-pointer my-4 p-3 pr-28 rounded-lg flex items-center transition-all w-full">
              <FiSettings size={20} />
      ...
      <main className="flex-1 p-4 bg-gray-100 min-h-screen lg:ml-60">
        <button
          className="lg:hidden bg-purple-500 text-white p-2 rounded-md"
